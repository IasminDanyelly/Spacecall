    ...
    const [idCustomer, setIdCustomer] = useState(false)
      ...
      useEffect( () => {   
          async function loadCustomers(){
            ...
            .catch((error) => {
               console.log('Erro ao encontrar empresa cadastrada', error)
               loadCustomer(false)
               setClientes([{id:'1', nomeFantasia: 'Freela'}])
            })
          }
      ...
      async function handleRegister(e){
        ...
        if(idCustomer){
            ...
            await updateDoc(docRef, {
                created: new Date(),
                cliente: clientes[customerSelected].nomeFantasia,
                clienteId:  clientes[customerSelected].id,
                assunto: assunto,
        ...
        .catch((error) => {
            toast.error("Ops error ao registrar, tente novamente!")
            console.log(error)
        })
      } 
        return(  
